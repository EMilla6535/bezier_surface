...
def createBorder():
    ...
    # Mover los handlers a una posicion por defecto
    # Importante! Tener en cuenta que Blender considera el punto 3 como el
    # 0 en mi interpretacion. El orden sigue siendo en  sentido de las
    ...
    p[1].handle_left = (p[1].co[0] + 0.5, p[1].co[1] + 0.5, p[1].co[2])
    p[1].handle_right = (p[1].co[0] - 0.7, p[1].co[1], p[1].co[2])

    p[2].handle_left = (p[2].co[0] + 0.5, p[2].co[1] + 0.5, p[2].co[2])
    p[2].handle_right = (p[2].co[0], p[2].co[1] + 0.7, p[2].co[2])

    p[3].handle_left = (p[3].co[0] + 0.5, p[3].co[1] - 0.5, p[3].co[2])
    p[3].handle_right = (p[3].co[0] + 0.7, p[3].co[1], p[3].co[2])
